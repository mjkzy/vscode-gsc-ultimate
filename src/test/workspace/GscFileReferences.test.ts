...
suite('GscFileReferences', () => {
    ...
    test('GscFileReferences - lower upper case', async () => {
        try {
            ...
            tests.checkHover(hover1, GscMarkdownGenerator.generateFunctionDescription(
                { name: "funcName", parameters: [] },
                false,
                tests.filePathToUri("GscFileReferences.1/LowerUpperCaseFolder/FunctionReferencesFile.gsc").toString(),
                undefined,
                undefined).value);
            ...
            tests.checkHover(hover2, GscMarkdownGenerator.generateFunctionDescription(
                { name: "funcName", parameters: [] },
                false,
                tests.filePathToUri("GscFileReferences.1/LowerUpperCaseFolder/FunctionReferencesFile.gsc").toString(),
                undefined,
            ...
            tests.checkHover(hover3, GscMarkdownGenerator.generateFunctionDescription(
                { name: "funcName", parameters: [] },
                false,
                tests.filePathToUri("GscFileReferences.1/LowerUpperCaseFolder/FunctionReferencesFile.gsc").toString(),
                undefined,
            ...
            tests.checkHover(hover4, GscMarkdownGenerator.generateFunctionDescription(
                { name: "funcName", parameters: [] },
                false,
                tests.filePathToUri("GscFileReferences.1/LowerUpperCaseFolder/FunctionReferencesFile.gsc").toString(), undefined,
                undefined).value);
            ...
            tests.checkHover(hover5, GscMarkdownGenerator.generateFunctionDescription(
                { name: "includedFuncName", parameters: [] },
                false, 
                tests.filePathToUri("GscFileReferences.1/LowerUpperCaseFolder/FunctionReferencesFile.gsc").toString(), "Included via '#include'", undefined).value);
            ...
            tests.checkHover(hover6, GscMarkdownGenerator.generateFunctionDescription({ name: "LOCALFUNC", parameters: [] }, true, undefined, undefined, undefined).value);
